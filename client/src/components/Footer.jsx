         ...
         <div className="flex items-center justify-between md:justify-start gap-5">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-4 text-gray-400 flex flex-col md:items-start">
              ...
              <li><a href="/upload" className="hover:text-blue-400 transition-colors">Upload Notes</a></li>
              <li><a href="/download" className="hover:text-blue-400 transition-colors">Download Notes</a></li>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-4 text-gray-400 flex flex-col items-center md:items-start">
              ...
              <li><a href="mailto:support@sityog.edu" className="hover:text-blue-400 transition-colors">Contact Support</a></li>
            </ul>
          </div>
         </div>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-5 mb-6">
              <a href="https://github.com/C-W-Praduman" className="text-2xl hover:text-blue-400 transition-colors"><FaGithub /></a>
              ...
              <a href="mailto:sityogstudentaurangabad@gmail.com" className="text-2xl hover:text-blue-400 transition-colors"><FaEnvelope /></a>
            </div>
